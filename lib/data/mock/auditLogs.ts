...
export const MOCK_AUDIT_LOGS: Record<string, AuditLogEntry[]> = {
  "#DOS-35698": [
    { id: "aud-1", timestamp: "2026-05-18 10:15", author: "Me. A. Diarra (RCIC)", actionFr: "Ouverture du dossier et génération de la checklist EIMT (12 postes)", actionEn: "Opened matter and generated LMIA checklist (12 positions)" },
  ...
  "#DOS-35697": [
    { id: "aud-10", timestamp: "2026-05-16 11:00", author: "Me. A. Diarra (RCIC)", actionFr: "Ouverture du dossier Entrée Express - Catégorie Santé", actionEn: "Opened Express Entry matter - Healthcare category" },
  ...
  "#DOS-35696": [
    { id: "aud-20", timestamp: "2026-05-15 08:30", author: "Me. S. Lavoie (RCIC)", actionFr: "Ouverture du dossier Recrutement LMIA Exemption (8 infirmières)", actionEn: "Opened LMIA Exemption recruitment matter (8 nurses)" },
...
export function getAuditLogsForMatter(matterId: string): AuditLogEntry[] {
  return MOCK_AUDIT_LOGS[matterId] || [
    { id: "aud-def-1", timestamp: "2026-05-10 09:00", author: "Me. A. Diarra (RCIC)", actionFr: "Création du dossier CICC dans le registre officiel", actionEn: "Matter created in official CICC registry" },
