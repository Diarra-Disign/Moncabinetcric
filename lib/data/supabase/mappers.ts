...
export function toClient(r: Row): ClientRecord {
  return {
    ...
    legalName: optStr(r.legal_name),
    birthDate: optStr(r.birth_date),
    email: str(r.email),
    emailSecondary: optStr(r.email_secondary),
    phone: str(r.phone),
    phoneSecondary: optStr(r.phone_secondary),
...
export function toLead(r: Row): Lead {
  return {
    ...
    phone: str(r.phone),
    phoneSecondary: optStr(r.phone_secondary),
    citizenship: optStr(r.citizenship),
    residence: optStr(r.residence),
    notes: str(r.notes),
