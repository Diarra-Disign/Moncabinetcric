      ...
      {showNewModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-foreground/50 backdrop-blur-md p-4 animate-fadeIn overflow-y-auto">
          <form
            ...
            className="bg-card w-full max-w-2xl rounded-3xl border border-border shadow-2xl p-6 sm:p-8 flex flex-col gap-6 relative overflow-hidden my-8 max-h-[90vh] overflow-y-auto"
          >
            <div className="flex items-center justify-between pb-3 border-b border-border">
              <div>
                ...
                <h3 className="text-xl font-black text-foreground">Ajouter un Prospect (Avant-Mandat)</h3>
              </div>
              <button
                type="button"
            ...
            <div className="flex flex-col gap-3 bg-muted p-4 rounded-2xl border border-border">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5">
                ...
                >
                  ...
                  <span className={`text-[10px] ${newLeadIntent === "info" ? "text-primary-strong" : "text-muted-foreground"}`}>
                ...
                >
                  ...
                  <span className={`text-[10px] ${newLeadIntent === "consultation" ? "text-accent-foreground" : "text-muted-foreground"}`}>
                ...
                <button
                  ...
                  className={`p-3 rounded-xl border text-left transition-all cursor-pointer flex flex-col gap-1 ${
                    newLeadIntent === "mandate"
                      ? "bg-success text-background border-success/40 shadow-sm"
                ...
                >
                  ...
                  <span className={`text-[10px] ${newLeadIntent === "mandate" ? "text-success-strong" : "text-muted-foreground"}`}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              {newLeadType === "b2b" && (
                <div className="flex flex-col gap-1.5 sm:col-span-2">
                  <label className="text-xs font-extrabold text-muted-foreground uppercase tracking-wider">Raison Sociale de l&apos;Entreprise *</label>
                  <input
                    type="text"
                    required
              ...
              <div className="flex flex-col gap-1.5 sm:col-span-2">
                <label className="text-xs font-extrabold text-muted-foreground uppercase tracking-wider">Programme IRCC ou Service Souhaité</label>
                <select
                  value={newLeadVisa}
                  onChange={(e) => handleVisaChange(e.target.value)}
                  className="w-full px-4 py-2.5 text-xs font-bold rounded-2xl bg-muted border border-border focus:bg-card focus:border-primary/40 focus:outline-none transition-all"
                >
                  {PROGRAM_GROUPS.map((group) => (
                    <optgroup key={group.label} label={group.label}>
                      {group.options.map((opt) => (
              ...
              <div className="flex flex-col gap-2 sm:col-span-2 bg-primary/15 p-4 rounded-2xl border border-primary/40">
                <div className="flex items-center justify-between">
                  <label className="text-xs font-extrabold text-primary-strong uppercase tracking-wider flex items-center gap-1">
                    <DollarSign className="w-3.5 h-3.5 text-primary-strong" />
                    <span>Valeur Estimée des Honoraires ($ CAD) — Saisissable & Éditable</span>
                  </label>
                  <span className="text-[11px] text-primary-strong font-semibold">Modifiez le montant librement</span>
                </div>
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="flex-1 px-4 py-2.5 text-sm font-mono font-black rounded-2xl bg-card border border-primary/40 focus:border-primary/40 focus:outline-none transition-all text-primary-strong shadow-xs"
                  />
                  <span className="font-mono font-black text-xs text-primary-strong">CAD $</span>
                </div>

                {/* BOUTONS PRÉRÉGLAGES RAPIDES */}
                <div className="flex items-center gap-2 flex-wrap pt-1">
                  <span className="text-[10px] font-bold text-muted-foreground">Montants suggérés :</span>
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-extrabold text-muted-foreground uppercase tracking-wider">Praticabilité Initiale CICC</label>
                <select
              ...
              <div className="flex flex-col gap-1.5 sm:col-span-2">
                <label className="text-xs font-extrabold text-muted-foreground uppercase tracking-wider">Notes & Remarques Initiales</label>
                <textarea
                  rows={2}
            ...
            <div className="flex items-center justify-end gap-3 pt-4 border-t border-border">
              <button
                type="button"
                onClick={() => setShowNewModal(false)}
                className="px-5 py-2.5 rounded-2xl border border-border text-xs font-bold text-foreground hover:bg-muted transition-colors cursor-pointer"
              >
                Annuler
              </button>
              <button 
                type="submit"
                className="px-6 py-2.5 rounded-2xl bg-primary hover:bg-primary/90 text-primary-foreground text-xs font-bold shadow-md transition-all cursor-pointer inline-flex items-center gap-2"
              >
