...
- **Style** : Tailwind CSS v4 avec des variables définies dans `app/globals.css` (pas de `tailwind.config.ts`). Ne jamais utiliser de valeurs magiques (ex: `w-[42px]`) mais s'appuyer sur le système de design et les primitives dans `components/ui/`.
